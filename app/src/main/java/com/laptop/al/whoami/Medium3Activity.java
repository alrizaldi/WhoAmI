...
public class Medium3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn1 = (Button) findViewById(R.id.btn_medium3A);
        ...
        Button btn2 = (Button) findViewById(R.id.btn_medium3B);
        ...
        Button btn3 = (Button) findViewById(R.id.btn_medium3C);
        ...
        Button btn4 = (Button) findViewById(R.id.btn_medium3D);
    ...
    public void ambilNilai(){
        setnSebelum(getIntent().getExtras().getString("m2"));
    ...
    public void onBackPressed() {
        Toast.makeText(Medium3Activity.this, "You Must Finish This Session!", Toast.LENGTH_LONG).show();
    }
}
