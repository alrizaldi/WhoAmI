...
public class Hard4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn1 = (Button) findViewById(R.id.btn_hard4A);
        ...
        Button btn2 = (Button) findViewById(R.id.btn_hard4B);
        ...
        Button btn3 = (Button) findViewById(R.id.btn_hard4C);
        ...
        Button btn4 = (Button) findViewById(R.id.btn_hard4D);
    ...
    public void ambilNilai(){
        setnSebelum(getIntent().getExtras().getString("h3"));
    ...
    public void onBackPressed() {
        Toast.makeText(Hard4Activity.this, "You Must Finish This Session!", Toast.LENGTH_LONG).show();
    }
}
