...
public class Hard3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn1 = (Button) findViewById(R.id.btn_hard3A);
        ...
        Button btn2 = (Button) findViewById(R.id.btn_hard3B);
        ...
        Button btn3 = (Button) findViewById(R.id.btn_hard3C);
        ...
        Button btn4 = (Button) findViewById(R.id.btn_hard3D);
    ...
    public void ambilNilai(){
        setnSebelum(getIntent().getExtras().getString("h2"));
    ...
    public void onBackPressed() {
        Toast.makeText(Hard3Activity.this, "You Must Finish This Session!", Toast.LENGTH_LONG).show();
    }
}
